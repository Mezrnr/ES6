{
    ...
    console.log(regex.test('xyz123'), regex2.test('xyz123')); // true ture 

    // es6 的写法: 
    let regex3 = new RegExp(/abc/ig, 'i'); // 允许添加修饰符 会覆盖
    console.log(regex3.flags); //原有正则对象的修饰符是ig，它会被第二个参数i覆盖    .flags 为新添加的获取修饰符的方法
